        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-8 md:pt-16 md:gap-10">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              <Card className="transition-transform transform hover:scale-105 p-4 md:p-6 lg:p-8 bg-transparent group border-none">
                <div className="relative p-4 duration-700 group-hover:bg-zinc-800/50 rounded-lg group-hover:scale-105">
                  {item.content}
